...
var fs = require('fs');
var selectResponse = require('./../../libraries/selectResponse.js');
...
function stepfn(e, step, input, response, context, cb) {
	...
	query = util.addIntentInCopiedFromWhereQuery(query, actionmap, context[constants.STEP_COUNTER]);
	...
	require('request')(options, function(e, res, body) {
		...
		selectResponse.selectQuestionEntitiesFromElasticResponse(body, response[constants.decision])
...
exports.walk_actions = function(map) {
	var i, leni, arri, j, lenj, arrj, a, n, actions_root;
