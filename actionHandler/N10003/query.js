...
function custom_logic(actionmap, body, input, context) {
	...
	context['Reason'] = '';
	context['Action'] = '';
	if(('CTX_RES_GRADE_FORGIVENESS_AVAILABLE' in context)) {
		context['Status'] = 'You have '+context['CTX_RES_GRADE_FORGIVENESS_AVAILABLE']+' grade forgiveness units';
	}
	if(('CTX_RES_GRADE_FORGIVENESS_USED' in context) && ('CTX_RES_GRADE_FORGIVENESS_LIMIT' in context)) {
		context['Reason'] = 'You have availed '+context['CTX_RES_GRADE_FORGIVENESS_USED']+' of '+context['CTX_RES_GRADE_FORGIVENESS_LIMIT'];
	}
